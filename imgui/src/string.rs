...
impl UiBuffer {
    ...
    pub fn scratch_txt(&mut self, txt: impl AsRef<str>) -> *const sys::cty::c_char {
        ...
        let start_of_substr = self.push_len(txt);
    ...
    pub fn scratch_txt_two(
        ...
        let first_offset = self.push_len(txt_0);
        let second_offset = self.push_len(txt_1);
    ...
    /// starts.
    pub fn push_len(&mut self, txt: impl AsRef<str>) -> usize {
